(function expose(root, factory) {
  ...
  function normalizeDeal(raw, now = new Date()) {
    ...
    return {
      ...
      category,
      tossRank: Number.isInteger(raw.tossRank) && raw.tossRank > 0 ? raw.tossRank : null,
      reviewScore: typeof raw.reviewScore === 'number' ? raw.reviewScore : null,
      reviewCount: Number.isSafeInteger(raw.reviewCount) ? raw.reviewCount : 0,
      clicks24h: Number.isSafeInteger(raw.clicks24h) ? raw.clicks24h : 0,
